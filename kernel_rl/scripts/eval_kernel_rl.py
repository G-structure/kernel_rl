...
Usage:
    python -m kernel_rl.scripts.eval_kernel_rl \
...
def main():
    ...
    if cfg.tensorboard_log_dir:
        ...
        from kernel_rl.training.tensorboard_logger import create_tensorboard_logger
        from kernel_rl.evaluation.eval_kernelbench import EvalResults, ProblemResult
